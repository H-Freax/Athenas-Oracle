...
# load the agent
from llm_helper import convert_message, get_rag_chain, get_rag_fusion_chain, get_rag_chain_files, \
    get_rag_fusion_chain_files, get_rag_chain_files_ollama, get_rag_fusion_chain_files_ollama

rag_method_map = {
    # 'Basic RAG': get_rag_chain,
    "Basic RAG": get_rag_chain_files_ollama,
    'RAG Fusion': get_rag_fusion_chain_files_ollama
}
